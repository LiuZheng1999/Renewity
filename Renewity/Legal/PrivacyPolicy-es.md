...
Suscripciones, categorías, notas, iconos, divisa, apariencia, notificaciones, bloqueo, etc. se guardan **en el dispositivo** (SwiftData / almacenamiento del sistema). Sirven para mostrar y gestionar, totales, aviso local el día anterior. Desinstalar suele borrar lo que solo está en el dispositivo y no hayas copiado a otro sitio.
...
## 9. Analítica, publicidad y seguimiento
