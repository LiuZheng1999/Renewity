...
Renewity (die „App“) wird vom Entwickler der App („wir“) bereitgestellt. Diese Erklärung beschreibt, wie die App Informationen über dich verarbeitet.

Die App ist so gebaut, dass **Abo-Einträge standardmäßig auf dem Gerät bleiben**. Wir betreiben keinen Anmelde-Server und erheben über die App keine personenbezogenen Daten für Werbung oder Profiling.

Fragen: **philiptrip1975@gmail.com**

## 1. Was wir über die App nicht erheben

Außer wie unten beschrieben verlangen wir kein Konto bei uns und laden Folgendes nicht auf von uns kontrollierte Server: Name oder E-Mail (außer du schreibst uns), eingegebene Abo-Daten, Werbekennungen oder Analytics-SDKs zur geräteübergreifenden Verfolgung.

Die App **enthält keine Werbe-SDKs Dritter und keine Analytics-Tools für Cross-App-Tracking**.
...
Weicht die Anzeigewährung von der lokalen Referenz ab, können Referenzkurse von einer öffentlichen API (derzeit `open.er-api.com`) kommen – nur Schätzung, kein Devisenangebot.

Bei „Dienst wählen“ können App-Store-/iTunes-Suche, öffentliche Domain-Dienste (z. B. Clearbit) und Icon-CDNs (icon.horse, unavatar.io, favicone.com u. a.) genutzt werden. **Suchbegriffe oder Domains** können dorthin gehen. Keine Passwörter oder Kartendaten ins Suchfeld. Treffer sind keine Empfehlung.
...
Bitte „Datenschutz“ in den Betreff.
